...
class LJSpeechCollector(object):
    ...
    def __init__(self, padding_idx=0, padding_value=0., padding_stop_token=1):
    ...
    def __call__(self, examples):
        ...
        mels = np.transpose(batch_spec(mels, pad_value=self.padding_value), axes=(0, 2, 1))
        stop_tokens = batch_text_id(stop_tokens, pad_id=self.padding_stop_token, dtype=mels[0].dtype)
